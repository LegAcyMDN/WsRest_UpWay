...
namespace WsRest_UpWay.Models.DataManager
{
    public class CategorieArticleManager : IDataRepository<CategorieArticle>
    {
        ...
        public async Task<ActionResult<IEnumerable<CategorieArticle>>> GetAllAsync()
        {
        ...
        {
            return await s215UpWayContext.CategorieArticles.FirstOrDefaultAsync(u => u.TitreCategorieArticle.ToUpper() == str.ToUpper());
        }
